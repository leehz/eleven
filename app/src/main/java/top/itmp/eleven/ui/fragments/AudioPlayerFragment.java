...
import top.itmp.eleven.MusicPlaybackService;
import top.itmp.eleven.R;
import top.itmp.eleven.adapters.AlbumArtPagerAdapter;
import top.itmp.eleven.cache.ImageFetcher;
import top.itmp.eleven.loaders.NowPlayingCursor;
import top.itmp.eleven.loaders.QueueLoader;
import top.itmp.eleven.menu.CreateNewPlaylist;
import top.itmp.eleven.menu.DeleteDialog;
import top.itmp.eleven.menu.FragmentMenuItems;
import top.itmp.eleven.ui.activities.HomeActivity;
import top.itmp.eleven.utils.ApolloUtils;
import top.itmp.eleven.utils.MusicUtils;
import top.itmp.eleven.utils.NavUtils;
import top.itmp.eleven.utils.PreferenceUtils;
import top.itmp.eleven.widgets.BrowseButton;
import top.itmp.eleven.widgets.LoadingEmptyContainer;
import top.itmp.eleven.widgets.NoResultsContainer;
import top.itmp.eleven.widgets.PlayPauseProgressButton;
import top.itmp.eleven.widgets.QueueButton;
import top.itmp.eleven.widgets.RepeatButton;
import top.itmp.eleven.widgets.RepeatingImageButton;
import top.itmp.eleven.widgets.ShuffleButton;
import top.itmp.eleven.widgets.VisualizerView;
