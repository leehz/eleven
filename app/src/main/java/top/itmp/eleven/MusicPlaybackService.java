...
import top.itmp.eleven.Config.IdType;

import top.itmp.eleven.IElevenService;
import top.itmp.eleven.R;
import top.itmp.eleven.appwidgets.AppWidgetLarge;
import top.itmp.eleven.appwidgets.AppWidgetLargeAlternate;
import top.itmp.eleven.appwidgets.AppWidgetSmall;
import top.itmp.eleven.cache.ImageCache;
import top.itmp.eleven.cache.ImageFetcher;
import top.itmp.eleven.provider.MusicPlaybackState;
import top.itmp.eleven.provider.RecentStore;
import top.itmp.eleven.provider.SongPlayCount;
import top.itmp.eleven.service.MusicPlaybackTrack;
import top.itmp.eleven.utils.BitmapWithColors;
import top.itmp.eleven.utils.Lists;
import top.itmp.eleven.utils.ShakeDetector;
import top.itmp.eleven.utils.SrtManager;
...
public class MusicPlaybackService extends Service {
     ...
     */
    public static final String PLAYSTATE_CHANGED = "top.itmp.eleven.playstatechanged";

    /**
     * Indicates that music playback position within
     * a title was changed
     */
    public static final String POSITION_CHANGED = "top.itmp.eleven.positionchanged";

    /**
     * Indicates the meta data has changed in some way, like a track change
     */
    public static final String META_CHANGED = "top.itmp.eleven.metachanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String QUEUE_CHANGED = "top.itmp.eleven.queuechanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String PLAYLIST_CHANGED = "top.itmp.eleven.playlistchanged";

    /**
     * Indicates the repeat mode changed
     */
    public static final String REPEATMODE_CHANGED = "top.itmp.eleven.repeatmodechanged";

    /**
     * Indicates the shuffle mode changed
     */
    public static final String SHUFFLEMODE_CHANGED = "top.itmp.eleven.shufflemodechanged";

    /**
     * Indicates the track fails to play
     */
    public static final String TRACK_ERROR = "top.itmp.eleven.trackerror";

    /**
     * For backwards compatibility reasons, also provide sticky
     * broadcasts under the music package
     */
    public static final String ELEVEN_PACKAGE_NAME = "top.itmp.eleven";
     ...
     */
    public static final String SERVICECMD = "top.itmp.eleven.musicservicecommand";

    /**
     * Called to go toggle between pausing and playing the music
     */
    public static final String TOGGLEPAUSE_ACTION = "top.itmp.eleven.togglepause";

    /**
     * Called to go to pause the playback
     */
    public static final String PAUSE_ACTION = "top.itmp.eleven.pause";

    /**
     * Called to go to stop the playback
     */
    public static final String STOP_ACTION = "top.itmp.eleven.stop";

    /**
     * Called to go to the previous track or the beginning of the track if partway through the track
     */
    public static final String PREVIOUS_ACTION = "top.itmp.eleven.previous";

    /**
     * Called to go to the previous track regardless of how far in the current track the playback is
     */
    public static final String PREVIOUS_FORCE_ACTION = "top.itmp.eleven.previous.force";

    /**
     * Called to go to the next track
     */
    public static final String NEXT_ACTION = "top.itmp.eleven.next";

    /**
     * Called to change the repeat mode
     */
    public static final String REPEAT_ACTION = "top.itmp.eleven.repeat";

    /**
     * Called to change the shuffle mode
     */
    public static final String SHUFFLE_ACTION = "top.itmp.eleven.shuffle";
     ...
     * changes
     */
    public static final String REFRESH = "top.itmp.eleven.refresh";

    /**
     * Used by the alarm intent to shutdown the service after being idle
     */
    private static final String SHUTDOWN = "top.itmp.eleven.shutdown";

    /**
     * Called to notify of a timed text
     */
    public static final String NEW_LYRICS = "top.itmp.eleven.lyrics";

    /**
     * Called to update the remote control client
     */
    public static final String UPDATE_LOCKSCREEN = "top.itmp.eleven.updatelockscreen";
    ...
    private Notification buildNotification() {
        ...
        Intent nowPlayingIntent = new Intent("top.itmp.eleven.AUDIO_PLAYER")
